...
import type {
  ...
  DeleteOwnEducationResponse,
} from "@/api/api-education-queries/delete-own-education";
...
type Mutation = UseMutationOptions<
  AxiosResponse<DeleteOwnEducationResponse, unknown, object>,
  APIRequestError,
  DeleteOwnEducationArgs
>;
...
export const useDeleteOwnEducation = ({
  authUser,
  completeUser,
  onError,
  onSuccess,
  ...
  useMutation({
    ...
    onError,
    mutationFn: async (args: DeleteOwnEducationArgs) => {
      return await apiEducationQueries.deleteOwnEducation(args);
    },
  });
