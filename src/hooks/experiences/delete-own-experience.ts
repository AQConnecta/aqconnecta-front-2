...
import type {
  ...
  DeleteOwnExperienceResponse,
} from "@/api/api-experiences-queries/delete-own-experience";
...
type Mutation = UseMutationOptions<
  AxiosResponse<DeleteOwnExperienceResponse, unknown, object>,
  APIRequestError,
  DeleteOwnExperienceArgs
>;
...
export const useDeleteOwnExperience = ({
  authUser,
  completeUser,
  onError,
  onSuccess,
  ...
  useMutation({
    ...
    onError,
    mutationFn: async (args: DeleteOwnExperienceArgs) => {
      return await apiExperiencesQueries.deleteOwnExperience(args);
    },
  });
